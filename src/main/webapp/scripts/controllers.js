...
simplecraApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
simplecraApp.controller('MenuController', function ($scope) {
    });

simplecraApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
simplecraApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

simplecraApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
simplecraApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
simplecraApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
simplecraApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
simplecraApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 simplecraApp.controller('HealthController', function ($scope, HealthCheckService) {
...
simplecraApp.controller('ConfigurationController', function ($scope, resolvedConfiguration) {
    $scope.configuration = resolvedConfiguration;
});

simplecraApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
simplecraApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
simplecraApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
