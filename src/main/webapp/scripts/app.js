...
var simplecraApp = angular.module('simplecraApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'simplecraAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
